package com.water.animall.Phantom.model;
...
@OnlyIn(Dist.CLIENT)
public class TamePhantomModel<T extends TamePhantomEntity> extends HierarchicalModel<T> {
    ...
    public TamePhantomModel(ModelPart p_170788_) {
        this.root = p_170788_;
