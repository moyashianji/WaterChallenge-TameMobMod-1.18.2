package com.water.animall.Enderman.layer;
...
@OnlyIn(Dist.CLIENT)
public class TameCarriedBlockLayer extends RenderLayer<TameEnderMan, EndermanModel<TameEnderMan>> {
    public TameCarriedBlockLayer(RenderLayerParent<TameEnderMan, EndermanModel<TameEnderMan>> p_116626_) {
        super(p_116626_);
    }

    public void render(PoseStack p_116639_, MultiBufferSource p_116640_, int p_116641_, TameEnderMan p_116642_, float p_116643_, float p_116644_, float p_116645_, float p_116646_, float p_116647_, float p_116648_) {
