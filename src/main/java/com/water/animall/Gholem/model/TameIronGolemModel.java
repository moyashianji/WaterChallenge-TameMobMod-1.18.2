package com.water.animall.Gholem.model;
...
@OnlyIn(Dist.CLIENT)
public class TameIronGolemModel<T extends TameIronGolem> extends HierarchicalModel<T> {
    ...
    public TameIronGolemModel(ModelPart p_170697_) {
        this.root = p_170697_;
