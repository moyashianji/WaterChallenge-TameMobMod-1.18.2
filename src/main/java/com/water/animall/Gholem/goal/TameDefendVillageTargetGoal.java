package com.water.animall.Gholem.goal;
...
public class TameDefendVillageTargetGoal extends TargetGoal {
    private final TameIronGolem golem;
    @Nullable
    private LivingEntity potentialTarget;
    private final TargetingConditions attackTargeting = TargetingConditions.forCombat().range(64.0D);

    public TameDefendVillageTargetGoal(TameIronGolem p_26029_) {
