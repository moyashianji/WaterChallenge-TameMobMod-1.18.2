...
import com.water.tamemobitem.procedures.TameblazeYoukuritukusitatokiProcedure;
...
public class TameblazeItem extends Item {
	public TameblazeItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		TameblazeYoukuritukusitatokiProcedure.execute(world, x, y, z);
		return ar;
	}
}
