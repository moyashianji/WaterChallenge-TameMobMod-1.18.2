...
import com.water.tamemobitem.procedures.TameghastYoukuritukusitatokiProcedure;
...
public class TameghastItem extends Item {
	public TameghastItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		TameghastYoukuritukusitatokiProcedure.execute(world, x, y, z);
		return ar;
	}
}
