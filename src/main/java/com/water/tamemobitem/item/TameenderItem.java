...
import com.water.tamemobitem.procedures.TameenderYoukuritukusitatokiProcedure;
...
public class TameenderItem extends Item {
	public TameenderItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		TameenderYoukuritukusitatokiProcedure.execute(world, x, y, z);
		return ar;
	}
}
