...
import com.water.tamemobitem.procedures.TamegolemYoukuritukusitatokiProcedure;
...
public class TamegolemItem extends Item {
	public TamegolemItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		TamegolemYoukuritukusitatokiProcedure.execute(world, x, y, z);
		return ar;
	}
}
