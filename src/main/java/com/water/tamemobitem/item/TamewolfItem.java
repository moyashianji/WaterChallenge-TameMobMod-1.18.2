...
import com.water.tamemobitem.procedures.TamewolfYoukuritukusitatokiProcedure;
...
public class TamewolfItem extends Item {
	public TamewolfItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		TamewolfYoukuritukusitatokiProcedure.execute(world, x, y, z);
		return ar;
	}
}
