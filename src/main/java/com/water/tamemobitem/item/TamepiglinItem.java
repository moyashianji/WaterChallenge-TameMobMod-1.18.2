...
import com.water.tamemobitem.procedures.TamepiglinYoukuritukusitatokiProcedure;
...
public class TamepiglinItem extends Item {
	public TamepiglinItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		TamepiglinYoukuritukusitatokiProcedure.execute(world, x, y, z);
		return ar;
	}
}
